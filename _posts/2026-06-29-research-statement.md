...
What drives all of it is easy to say and hard to overstate: the thrill of being first to see something real — a glimpse through the empirical mist at something that was always there but never seen. History is the only place where the world looks different enough to shed light on the disruptions ahead, and clearing a little of that mist is, to me, as much a privilege as it is a job.
